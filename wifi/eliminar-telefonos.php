...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Deseas Eliminar el Telefono</span>
                      </button>
           ...
           <center>
            <form method="post"  action="sql/eliminar-telefonos.php?id=<?php echo $id;?>">
     Bien Nacional<input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['bn'];?>" required ><br>
     Marca<input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['marcas'];?>" required >
   </div>   
    </div>
  </div>
