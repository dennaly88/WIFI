...
$edit_ced=$_POST['edit_ced'];
     ...
     $query = "UPDATE usuarios SET id='$edit_id', usuario='$edit_usu', pass='$edit_pass',perfil='$edit_per',correo='$edit_cor', nombre='$edit_nom',apellido='$edit_ape' ,telefono='$edit_tel' ,cedula='$edit_ced'
