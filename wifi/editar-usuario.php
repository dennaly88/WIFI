...
Nombre<br><input class="form-control form-control-sm" type="text" name="edit_nom" id="edit_nom" placeholder="nombre" value="<?php echo $row['nombre'] ?>" required >
Apellido<input class="form-control form-control-sm" type="text" name="edit_ape" id="edit_ape" placeholder="apellido" value="<?php echo $row['apellido'] ?>" required >
