...
<a href="principal-eliminar-sistemas.php?id=<?php echo $id;?>"> 
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
        ...
        <a href="principal-editar-sistemas.php?id=<?php echo $id;?>"> 
...
<span aria-hidden="true">Agregar Sistema Operativo</span>
              </div>
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/ingresar-sistemas.php">
...
<center> <button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal" onclick="location.href='principal-sistemas.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-light">Sistemas Operativos</span>
