...
$query = "SELECT * FROM sistemas WHERE id ='$id'";
...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Deseas Eliminar el Sistema</span>
                      </button>
           ...
           <center>
            <form method="post"  action="sql/eliminar-sistemas.php?id=<?php echo $id;?>">
