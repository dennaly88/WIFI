...
?>
    ...
    <div class="modal fade" id="danny" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Editar Monitor</span>
                      </button>
                      </h5>  
                              </div>
           ...
           <center>
            <form method="post"  action="sql/editar-monitor.php">
...
Marca<input class="form-control form-control-sm" type="text" name="mar_edit" id="mar_edit" placeholder="marca" value="<?php echo $row['marca'] ?>" required >
