...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Deseas Eliminar el  WIFI</span>
                      </button>
           ...
           <center>
            <form method="post"  action="sql/eliminar-wifi.php?id=<?php echo $id;?>">
            IP<input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['ip'];?>" required ><br>
            Nombre<input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['ssid'];?>" required >
   </div>   
    </div>
  </div>
