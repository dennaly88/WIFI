...
<a href="principal-eliminar-marca.php?id=<?php echo $id;?>"> 
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
        ...
        <a href="principal-editar-marca.php?id=<?php echo $id;?>"> 
...
<span aria-hidden="true">Crear Marca</span>
              </div>
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
           <center>
            <form method="post"  action="sql/ingresar-marca.php">
...
<center> <button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal" onclick="location.href='principal-marcas.php'" style="max-width: 10rem;" >
                      <span aria-hidden="true" class="text-light">Marcas</span>
